let images = [
   ...
   "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768556776/download_xno5gv.png",
   "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768556749/sherwani3_r8cnha.png",
   "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768556744/sherwani_ravjru.png",
   "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768556722/sherwani2_oynp1k.png",
   "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768556721/Sherman_I_vxjl8f.png",
   "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768556721/5c9e2060-e0d8-4f64-9cab-20b3bdd5ad93_g0nrsu.png",
    ]
...
for(let i = 0 , pathNum = 0 ; i < images.length ; i++ ){
  ...
  <button class="mr-2">
	<svg class="text-yellow-500 max-[440px]:w-3 w-6 h-auto fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
      ...
      <a href = "coatDetail.html?id=${data[i].id}&images=${images[i]}" class=" m-auto" >   <button class="group relative px-6 py-2 overflow-hidden rounded-lg bg-white text-neutral-900 shadow ring-1 ring-neutral-900 transition-all hover:ring-gray-500">
