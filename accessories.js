let images = [
    ...
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486956/giorgio-trovato-K62u25Jk6vo-unsplash.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486950/532d15ab-0a47-4cde-a757-8d4c7070beac.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486949/Ermenegildo_Zegna_Woven_Silk_Tie.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486945/istockphoto-641523494-612x612.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486942/Gucci-Belt-PNG-Isolated-HD.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486936/istockphoto-528976984-612x612.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486933/523c413e-8f6b-44ab-845a-408071f87d9d.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486909/97962f1f-58ed-4744-bcb4-730af1a2da86.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486908/12573.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486908/Gucci-Belt-PNG-Pic.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768486904/Gucci-Belt-PNG-Isolated-Pic.png"
]
...
for(let i = 0 , pathNum = 0 ; i < images.length ; i++ ){
    ...
    div[i].innerHTML = `
      <img src=${images[i]} class="rounded-[15px] w-[min(75%,300px)] m-auto transition-all duration-[1s] group-hover:-translate-x-[20px] group-hover:-translate-y-[30px] group-hover:scale-[1.2]  "></img>
        ...
        <div class="flex justify-between flex-col ">
          <div class="flex justify-center  items-center mb-4 bg-white px-1 max-[540px]:px-0.5  py-1  rounded-lg w-fit h-fit space-x-1 lg:space-x-1">
  <button>        
	<svg class="text-yellow-500 max-[440px]:w-3 w-6 h-auto fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
	  <path />
	</svg>
  </button>
  ...
  <button class="mr-2">
	<svg class="text-yellow-500 max-[440px]:w-3 w-6 h-auto fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
      ...
      <a href = "accessoriesDetail.html?id=${data[i].id}&images=${images[i]}" class=" m-auto" >   <button class="group relative px-6 py-2 overflow-hidden rounded-lg bg-white text-neutral-900 shadow ring-1 ring-neutral-900 transition-all hover:ring-gray-500">
