let images = [
    ...
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768443864/ryan-waring-164_6wVEHfI-unsplash_f4bere.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768443831/cris-fIflxqqzBQY-unsplash_xdrnzu.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768443806/pexels-elnur-memmednebiyev-125323681-9992899_kyg86y.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768443780/the-dk-photography-NUoPWImmjCU-unsplash_ckjivt.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768443763/reebok-2061623_1280_jodkbl.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768443757/zakaria-issaad-BGKYYeKkzNg-unsplash_xidcjm.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768443735/prada_xjmjee.png",
    "https://res.cloudinary.com/duf2jzwsg/image/upload/v1768443728/usama-akram-kP6knT7tjn4-unsplash_koyke2.png"
]
 ...
 <button>        
  ...
  <button class="mr-2">
	<svg class="text-yellow-500 max-[440px]:w-3 w-6 h-auto fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
      ...
      <a href = "shoes.html?id=${data[i].id}&images=${images[i]}" class=" m-auto" >   <button class="group relative px-6 py-2 overflow-hidden rounded-lg bg-white text-neutral-900 shadow ring-1 ring-neutral-900 transition-all hover:ring-gray-500">
